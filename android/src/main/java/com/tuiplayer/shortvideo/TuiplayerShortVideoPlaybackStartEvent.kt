...
internal class TuiplayerShortVideoPlaybackStartEvent(
  surfaceId: Int,
  viewId: Int,
  private val index: Int,
  private val total: Int,
  private val source: WritableMap?
) : Event<TuiplayerShortVideoPlaybackStartEvent>(surfaceId, viewId) {
  ...
  companion object {
    const val EVENT_NAME = "topPlaybackStart"
  }
}

package com.txplayer.ftuiplayer.common;

public final class FTUIConstant {

  public static final String VIEW_TYPE = "TUIShortVideoItemView";

  public static final String EVENT_PLAY_EVENT = "txplayer.onPlayEvent";
